            ...
            <div className={styles.TodoList}>
                ...
                <ul>
                    {visibleTodos.map((todo) => (
                        ...
                        <h3 style={{width: "100px"}}>{todo.title}</h3>
                        <p style={{width: "150px"}}>{todo.description}</p>
                        <p>Status:<br />  {todo.status}</p>
                        <p>Estimated Time:<br /> {todo.estimatedTime}</p>
                        <p>Category:<br />  {todo.category}</p>
                        <p>Deadline:<br />  {todo.deadline}</p>
